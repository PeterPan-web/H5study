...
export default {
  ...
  vm_patient_saveMedicalData: 'cmnt/careleader/saveMedicalData', // 完善病历卡和病历详情（完善资料任务）
  ...
  // 用药方案备忘 start
  vm_patient_getMedicationPlan: 'vm/patient/medicationPlan/get', // 获取用药方案 vm/patient/medicationPlan/get
  vm_patient_medicationPlan_getHistoryList: 'vm/patient/medicationPlan/getHistoryList', // 获取患者历史用药方案列表 vm/patient/medicationPlan/getHistory
