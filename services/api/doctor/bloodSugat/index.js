...
// 获取CGM数据
function bsCgmGetCgmList (params) {
  return doGet(params, url.bs_cgm_getCgmList)
}
...
// 患者CGM血糖统计数据列表查询
function vmMomentCgmStatisticListByPatient (params) {
  return doGet(params, url.vm_moment_cgmStatisticListByPatient)
}
...
export {
  ...
  vmMomentCgmStatisticListByPatient
}
