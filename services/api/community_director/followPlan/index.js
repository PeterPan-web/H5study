...
// 批注列表
function vmFollowupPlanGetPostilList (params) {
  return doGet(params, url.vm_followupPlan_getPostilList)
}

// 批注详情
function vmFollowupPlanGetPostilDetail (params) {
  return doGet(params, url.vm_followupPlan_getPostilDetail)
}
...
export {
  ...
  vmFollowupPlanGet,
  vmFollowupPlanGetPostilList,
  vmFollowupPlanGetPostilDetail
}
